// scalar reference for myocyte: myocyte.cl compiled as C. Generated by the Makefile, do not edit.
#define __kernel
#define __global
#define __constant
#define __local
static int ref_bx, ref_tx;
#define get_group_id(d) ref_bx
#define get_local_id(d) ref_tx
#include <math.h>
#define exp expf
#define log logf
#define log10 log10f
...
__kernel void 
kernel_gpu_opencl_c(	int timeinst,
					__global fp *d_initvalu,
					__global fp *d_finavalu,
					__global fp *d_params,
					__global fp *d_com)
...
void ref_kernel(int t, float *iv, float *fv, float *p, float *c, int bx, int tx) { ref_bx = bx; ref_tx = tx; kernel_gpu_opencl_c(t, iv, fv, p, c); }
