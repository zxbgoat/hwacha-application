// Reference: the Rodinia OpenMP heartwall kernel (define.c + kernel.c, unmodified apart from the
// function name), run once per point per frame by heartwall_main.c.
#include <math.h>
//===============================================================================================================================================================================================================
//===============================================================================================================================================================================================================
//	DEFINE / INCLUDE
...
typedef struct public_struct{
	...
	void* d_frames;   // avi_t* in the original: the AVI reader is not part of this case
	int frames;
	int frame_no;
	fp* d_frame;
	int frame_rows;
...
void heartwall_ref(public_struct public,
