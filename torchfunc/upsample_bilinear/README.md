...
`torch.nn.functional.upsample_bilinear`（线性）的单函数测试，一次调用，与 PyTorch 逐元素比对。文档：https://docs.pytorch.org/docs/2.14/generated/torch.nn.functional.upsample_bilinear.html

导出图计算：`F.upsample_bilinear(x, scale_factor=2)`
...
make gen-upsample_bilinear      # 从 PyTorch 重新生成
```
