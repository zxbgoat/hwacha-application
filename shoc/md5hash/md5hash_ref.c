// SHOC MD5Hash: the host-side MD5 (md5_2words and IndexToKey of MD5Hash.cpp, unmodified) used as the
// scalar reference and to compute the target digest.
#include <stdio.h>
...
void md5_2words(unsigned int *words, unsigned int len,
                       unsigned int *digest)
{
