...
`torch.nn.functional.softshrink`（非线性激活）的单函数测试，一次调用，与 PyTorch 逐元素比对。文档：https://docs.pytorch.org/docs/2.14/generated/torch.nn.functional.softshrink.html

导出图计算：`F.softshrink(x)`
...
make gen-softshrink      # 从 PyTorch 重新生成
```
