...
| `tvintf/` | torchvision.transforms.v2 image transforms (42, random ones pinned to one draw) torchvision.ops (41: boxes, NMS, losses, RoI operators, deformable convolution, layers) and torchvision.utils (7: grids, drawing, flow colouring) | 90 |
